...
package com.mobileglobe.android.customdialer.voicemail;
...
import com.mobileglobe.android.customdialer.database.VoicemailArchiveContract.VoicemailArchive;
import com.mobileglobe.android.customdialer.util.AsyncTaskExecutor;
import com.mobileglobe.android.customdialer.util.AsyncTaskExecutors;
        ...
        Snackbar.make(this, R.string.snackbar_voicemail_archived,
                ...
                .setAction(R.string.snackbar_voicemail_archived_goto,
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                // we don't need this archive for now
                                /**
                                 * @TODO
